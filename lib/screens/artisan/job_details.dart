...
class _JobDetailsScreenState extends State<JobDetailsScreen> {
      ...
      body: _isLoading
          ...
          : Consumer<RequestProvider>(
              builder: (context, requestProvider, child) {
                final job = requestProvider.requests
                    .where((r) => r.id == widget.jobId)
                    .firstOrNull;
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Carte devis (si accepté)
                        if (job.status == 'accepted' || job.status == 'in_progress') ...[
                          _buildQuoteCard(job),
                          const SizedBox(height: 16),
                        ],

                        // Carte progression (si en cours)
  ...
  Widget _buildStatusCard(Request job) {
    Color statusColor;
    String statusText;
    IconData statusIcon;
  ...
  Widget _buildBasicInfoCard(Request job) {
    return Card(
      elevation: 4,
      child: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow('Date souhaitée', _formatDate(job.preferredDate), Icons.event),
  ...
  Widget _buildDescriptionCard(Request job) {
    return Card(
      elevation: 4,
      child: Padding(
        padding: const EdgeInsets.all(16),
